...
const htmlcontent = compiler.outputFileSystem.readFile(path.join(compiler.outputPath,"/static/js/main.js"));
if (!Buffer.isBuffer(htmlcontent)) {
  htmlcontent = new Buffer(htmlcontent, "utf8"); //eslint-disable-line
}
compiler.outputFileSystem.writeFile(path.join(compiler.outputPath,"/static/js/main.js"),htmlcontent,function(err){
    console.log(err+"\n");
})
var _resolve
